...
- **Trip Corrections philosophy** (`docs/TRIP_CORRECTIONS.md`): Added section on "Recording User Intent in Corrections" — documents the approach of preserving what the user actually meant to enter during high-impact corrections (rather than immediately forcing normalized names) so future models can learn from realistic imperfect data.
