...
- **Admin navigation now separates the overview from Stops, Users, and Insights**, keeping each operational area focused while preserving the dashboard header layout.
